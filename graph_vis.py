...
def data_to_graph(file_name):
    with open(file_name, "r") as file:
        ...
        surface.plot(range(0, 6000), result_array[0], color="red", alpha=0.3, label="Va", marker="s", markerfacecolor="black", markersize=1)
        surface.plot(range(0, 6000), result_array[1], alpha=0.3, color="blue", label="Vw", marker="o", markerfacecolor="black", markersize=1)
...
data_to_graph(file_name="equations.txt")